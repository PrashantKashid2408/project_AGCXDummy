...
/**
 * Generic type of audio recv media stats
 * @beta
 */
export declare interface AudioRecvMediaStats<T> extends RecvMediaStats<T> {
    audioOutputLevel?: T;
    healedRatio?: T;
    lossRate?: T;
}
 ...
 * @beta
 */
export declare interface AudioSendMediaStats<T> extends SendMediaStats<T> {
    audioInputLevel?: T;
}
 ...
 * Call states.
 */
export declare type CallState = 'None' | 'Connecting' | 'Ringing' | 'Notified' | 'Connected' | 'LocalHold' | 'RemoteHold' | 'InLobby' | 'Disconnecting' | 'Disconnected' | 'EarlyMedia';
...
/**
 * Generic type of common media stats
 * @beta
 *
 * id is an identifier used to dintinguish when there are multiple streams with same media type/direction
 */
export declare interface CommonMediaStats<T> {
    id: string;
    codecName?: T;
    bitrate?: T;
    jitterInMs?: T;
    packetsPerSecond?: T;
    packetsLostPerSecond?: T;
    rttInMs?: T;
    pairRttInMs?: T;
    availableBitrate?: T;
}
 ...
 * @beta
 */
export declare type MediaStatRawValue = number | string | boolean;
...
/**
 * Payload for new media stats emitted sampleReported event.
 * @beta
 */
...
export declare interface MediaStatsReportSummary {
    audio: {
        send: AudioSendMediaStats<MediaStatValue>[];
        receive: AudioRecvMediaStats<MediaStatValue>[];
    };
    video: {
        send: VideoSendMediaStats<MediaStatValue>[];
        receive: VideoRecvMediaStats<MediaStatValue>[];
    };
    screenShare: {
        send: ScreenShareSendMediaStats<MediaStatValue>[];
        receive: ScreenShareRecvMediaStats<MediaStatValue>[];
    };
}

/**
 * Payload for new media stats emitted summaryReported event.
 * @beta
 */
...
/**
 * Generic type of recv media stats
 * @beta
 */
export declare interface RecvMediaStats<T> extends CommonMediaStats<T> {
    jitterBufferInMs?: T;
}
...
/**
 * Generic type of screenshare recv media stats
 * @beta
 */
export declare type ScreenShareRecvMediaStats<T> = VideoRecvMediaStats<T>;

/**
 * Generic type of screenshare send media stats
 * @beta
 */
export declare type ScreenShareSendMediaStats<T> = VideoSendMediaStats<T>;

/**
 * Generic type of send media stats
 * @beta
 */
export declare interface SendMediaStats<T> extends CommonMediaStats<T> {
}
...
/**
 * Generic type of video recv media stats
 * @beta
 *
 */
export declare interface VideoRecvMediaStats<T> extends RecvMediaStats<T> {
    /**
    ...
    frameRateDecoded?: T;
    frameRateReceived?: T;
    frameWidthReceived?: T;
    frameHeightReceived?: T;
    longestFreezeDurationInMs?: T;
    totalFreezeDurationInMs?: T;
    framesReceived?: T;
    framesDropped?: T;
    framesDecoded?: T;
    keyFramesDecoded?: T;
 ...
 * @beta
 */
export declare interface VideoSendMediaStats<T> extends SendMediaStats<T> {
    frameRateInput?: T;
    frameWidthInput?: T;
    frameHeightInput?: T;
    frameRateEncoded?: T;
