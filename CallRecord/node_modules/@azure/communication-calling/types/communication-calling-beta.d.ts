...
/**
 * Represents a Call API feature
 * @beta
 */
export declare interface CallApiFeature {
    /**
     * @public
     * The feature name
     */
...
/**
 * Represents the context provided for extended call features.
 * @beta
 */
export declare interface CallApiFeatureContext {
    /**
...
/**
 * Represents the type of the factory of CallApiFeature objects, along with the context provided for the added feature.
 * @beta
 */
export declare type CallFeatureFactoryType<TFeature extends CallApiFeature> = new (context: CallApiFeatureContext) => TFeature;
 ...
 * @beta
 */
export declare interface DominantSpeakersCallFeature extends CallApiFeature {
    /**
...
export declare const Features: {
    readonly Recording: CallFeatureFactoryType<RecordingCallFeature>;
    readonly Transfer: CallFeatureFactoryType<TransferCallFeature>;
    readonly Transcription: CallFeatureFactoryType<TranscriptionCallFeature>;
    readonly DominantSpeakers: CallFeatureFactoryType<DominantSpeakersCallFeature>;
};
 ...
 * @beta
 */
export declare type MeetingLocator = TeamsMeetingLinkLocator | TeamsMeetingCoordinatesLocator;
 ...
 * @beta
 */
export declare interface RecordingCallFeature extends CallApiFeature {
    /**
 ...
 * @beta
 */
export declare interface TranscriptionCallFeature extends CallApiFeature {
    /**
     * Indicates if transcription is active in current call
     */
    readonly isTranscriptionActive: boolean;
    /**
     * Subscribe function for isTranscriptionActiveChanged event
     * @param event - event name
     * @param listener - callback fn that was used to subscribe to this event
     */
    on(event: 'isTranscriptionActiveChanged', listener: PropertyChangedEvent): void;
    /**
     * Unsubscribe function for isTranscriptionActiveChanged event
     * @param event - event name
     * @param listener - callback fn that was used to subscribe to this event
     */
...
/**
 * Represents a Transfer Return Object
 * @beta
 */
 ...
 * @beta
 */
export declare interface TransferCallFeature extends CallApiFeature {
    /**
 ...
 * @beta
 */
export declare interface TransferToCall {
    targetCall: Call;
}

/**
 * Options for transfering a call into another call
 * @beta
 */
 ...
 * @beta
 */
export declare interface TransferToParticipant {
