...
namespace AdaniCall.Utility.Common
{
    public class Encription
    {
        ...
        public Encription()
        {
            ...
            string VectorValue = ConfigurationManager.AppSettings["AESUserVector"];
            string SaltValue = ConfigurationManager.AppSettings["AESUserSalt"];
            string strKey = ConfigurationManager.AppSettings["AESUserEncrryptKey"];
